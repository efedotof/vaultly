...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is LogoutRequest&&(identical(other.token, token) || other.token == token));
}
...
class _LogoutRequest implements LogoutRequest {
  const _LogoutRequest({required this.token});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _LogoutRequest&&(identical(other.token, token) || other.token == token));
}
