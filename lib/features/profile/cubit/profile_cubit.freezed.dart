...
class _UpdateError implements ProfileState {
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _UpdateError&&(identical(other.message, message) || other.message == message));
}
...
/// @nodoc
abstract mixin class _$UpdateErrorCopyWith<$Res> implements $ProfileStateCopyWith<$Res> {
