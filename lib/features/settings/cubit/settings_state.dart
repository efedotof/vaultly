...
class SettingsState with _$SettingsState {
  ...
  const factory SettingsState.totpSetupReady(String qrCodeUrl, String secret) = _TotpSetupReady;
  const factory SettingsState.totpVerifying() = _TotpVerifying;
  const factory SettingsState.totpEnabled(List<String> backupCodes) = _TotpEnabled;
  ...
  const factory SettingsState.seedReady(String mnemonic, List<String> words) = _SeedReady;
