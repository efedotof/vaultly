...
class _Loaded implements SettingsState {
  const _Loaded({required this.profile, required final  List<DeviceResponse> devices, this.cacheSizeBytes = 0}): _devices = devices;
  

 final  UserProfileDto profile;
 final  List<DeviceResponse> _devices;
...
@JsonKey() final  int cacheSizeBytes;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _Loaded&&(identical(other.profile, profile) || other.profile == profile)&&const DeepCollectionEquality().equals(other._devices, _devices)&&(identical(other.cacheSizeBytes, cacheSizeBytes) || other.cacheSizeBytes == cacheSizeBytes));
}


@override
int get hashCode => Object.hash(runtimeType,profile,const DeepCollectionEquality().hash(_devices),cacheSizeBytes);

@override
String toString() {
  return 'SettingsState.loaded(profile: $profile, devices: $devices, cacheSizeBytes: $cacheSizeBytes)';
}
...
@useResult
$Res call({
 UserProfileDto profile, List<DeviceResponse> devices, int cacheSizeBytes
});
...
/// Create a copy of SettingsState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') $Res call({Object? profile = null,Object? devices = null,Object? cacheSizeBytes = null,}) {
  return _then(_Loaded(
profile: null == profile ? _self.profile : profile // ignore: cast_nullable_to_non_nullable
as UserProfileDto,devices: null == devices ? _self._devices : devices // ignore: cast_nullable_to_non_nullable
as List<DeviceResponse>,cacheSizeBytes: null == cacheSizeBytes ? _self.cacheSizeBytes : cacheSizeBytes // ignore: cast_nullable_to_non_nullable
as int,
  ));
}
